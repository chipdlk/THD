...
namespace API.Areas.Admin.Models.ManagerFiles
{
    public class MIMETypesService
    {
        ...
        public static List<String> getlistHDSD()
        {
            List<String> listMIMETypes = new List<string>() { ".doc", ".docx", ".pdf", ".ppt", ".pptx" };
            return listMIMETypes;
        }

        public static List<String> getlistThietBi()
        {
            List<String> listMIMETypes = new List<string>() { ".csv", ".doc", ".docx", ".pdf", ".ppt", ".pptx" };
            return listMIMETypes;
        }
    }
}